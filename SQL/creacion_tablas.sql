...
Revision ID: 257710338a05
Revises: 
Create Date: 2024-11-18 00:36:57.395119
...
def upgrade():
    ...
    op.execute(
        """
            INSERT INTO empleado (id_empleado, id_persona, id_especialidad, fecha_ingreso, codigo_marcado, trato, tipo_empleado, cargo) VALUES
            (1, 1, null, '2015-08-20', 1001, 'Sr.', 'AP', 'Administrador'),
            (2, 2, null, '2017-03-14', 1002, 'Sra.', 'AT', 'Admisionista'),
            (3, 3, null, '2018-07-09', 1003, 'Sr.', 'AO', 'Encargado de Limpieza'),
            (4, 4, null, '2024-01-01', 1004, 'Sr.', 'AS', 'Administrador de Sistemas'),
            (5, 5, 2, '2024-01-01', 1005, 'Dr.', 'M', 'Ginécologo'),
            (6, 6, null, '2024-01-01', 1006, 'Dr.', 'E', 'Enfermera'),
            (7, 7, 1, '2024-01-01', 1007, 'Dr.','M', 'Médico General');
        """
    )
    ...
    op.execute(
        """
            ...
            INSERT INTO turno (id_turno, id_empleado, dia_semana, fecha_inicio, fecha_fin, hora_inicio, hora_fin, estado_turno, estado_reg) VALUES
            (1, 5, 'L', '2024-10-01', '2024-10-15', '08:00:00', '12:00:00', 'V', 'V'),
            (2, 7, 'M', '2024-10-02', '2024-10-16', '14:00:00', '18:00:00', 'V', 'A');
